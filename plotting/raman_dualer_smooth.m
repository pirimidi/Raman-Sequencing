...
% using linear Savitsky-Golay smoothing (4th degree polynomial, 25 data 
% points).
%
...
function raman_dualer_smooth(file_name_1, file_name_2)

fprintf('\n'); 
disp('--> Raman dualer smooth start');
...
smooth_1 = sgolayfilt(raman_1, 4, 25);
smooth_2 = sgolayfilt(raman_2, 4, 25);

R1 = smooth_1(:,1);   % Raman shift (cm^-1): dATP
R2 = smooth_2(:,1);   % Raman shift (cm^-1): N3-dATP
I1 = smooth_1(:,2);   % intensity (cnt): dATP
I2 = smooth_2(:,2);   % intensity (cnt): N3-dATP
